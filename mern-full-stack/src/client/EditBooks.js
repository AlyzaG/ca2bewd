                        ...
                        <div className="columns">
                            <div className="column is-half">
                                ...
                                <div className="field">
                                    ...
                                    <div className="control">
                                        <input className="input is-small" type="text" name="first" value={this.state.authors} onChange={this.handleChange} id="form" />
                                    </div>
                                </div>
                                <div className="field">
                                    <label className="label"> Year: </label>
                                    <div className="control">
                                        <input className="input is-small" type="text" name="first" value={this.state.year} onChange={this.handleChange} id="form" />
                                    </div>
                                </div>
                            </div>
                            {/*SECOND COLUMN*/}
